...
resource "null_resource" "ansible-deploy" {
  ...
  provisioner "local-exec" {
    command = "export ANSIBLE_HOST_KEY_CHECKING=False && ansible-playbook --private-key /home/maheswaris/.ssh/id_rsa -i hosts groupX-playbook.yml"
  }
}
